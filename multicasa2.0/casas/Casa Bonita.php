...
<body>
    ...
    <div class="cont">
        ...
        <div>
          <a href="casa/Casa Bonita.php">
            <img class="img-fluid rounded mb-3 mb-md-0" src="../uploads/Casa Bonita_1.jpg" alt="">
          </a>
        </div>
        <div>
          <h3>Casa Bonita</h3>
          <h5>Descricpión</h5>
          <p>Casas en venta en Fraccionamiento Villa Natura.
...
Terreno: 220 m2
Construcción: 180 m2.
$2,940,000 (Esta casa incluye cocina con granito, closets, muebles de baño.)</p>
          <h5>Dirección</h5>
          <p>Fraccionamiento Villa Natura, Bambú #1200</p>
          <h5>Costo</h5>
          <p>24000</p>
          ...
          <a href="#">
            <img class="img-fluid rounded mb-3 mb-md-0" src="../uploads/Casa Bonita_2.jpg" alt="">
          </a>
          <a href="#">
            <img class="img-fluid rounded mb-3 mb-md-0" src="../uploads/Casa Bonita_3.jpg" alt="">
          </a>
          <br>
          <h5>Ubicación</h5>
...
<script type="text/javascript">
              var mymap = L.map("mapid").setView([25.421682, -101.000155], 13);
              var marker = L.marker([25.421682, -101.000155]).addTo(mymap);
